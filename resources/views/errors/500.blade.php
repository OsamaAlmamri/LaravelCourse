...
<head itemscope="" itemtype="http://schema.org/WebSite">
    ...
    <title itemprop="name">Preview bootstrap html snippet. 500 error page with particles</title>
    <meta name="description" itemprop="description"
          content="Preview bootstrap html snippet. 500 error page with particles. Copy and paste the html, css and js code for save time, build your app faster and responsive">
    <meta name="keywords"
    ...
    <link rel="canonical" href="https://www.bootdey.com/snippets/view/500-error-page-with-particles" itemprop="url">
    ...
    <meta name="twitter:title" content="Preview bootstrap html snippet. 500 error page with particles">
    <meta name="twitter:description"
          content="Preview bootstrap html snippet. 500 error page with particles. Copy and paste the html, css and js code for save time, build your app faster and responsive">
    <meta name="twitter:image" content="https://www.bootdey.com/files/SnippetsImages/bootstrap-snippets-624.png">
    <meta name="twitter:url" content="https://www.bootdey.com/snippets/preview/500-error-page-with-particles">
    <meta property="og:title" content="Preview bootstrap html snippet. 500 error page with particles">
    <meta property="og:url" content="https://www.bootdey.com/snippets/preview/500-error-page-with-particles">
    <meta property="og:image" content="https://www.bootdey.com/files/SnippetsImages/bootstrap-snippets-624.png">
            ...
            <div class="outer">
                <div class="middle">
                    <div class="inner">
                        ...
                        <span class="inner-status">Opps! Internal Server Error!</span> <span class="inner-detail"
                                                                                             style="color:#fff;"> Unfortunately we're having trouble
loading the page you are looking for. Please come back in a while. </span></div>
                </div>
            </div>
        </div>
        <canvas class="particles-js-canvas-el" width="1152" height="575" style="width: 100%; height: 100%;"></canvas>
    </div>
